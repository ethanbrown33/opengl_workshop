...
int main()
{
	...
	*/
	Shader ourShader("/root/opengl_workshop/src/00_getting_started/04_coordinate_systems/04_vertex.glsl", "/root/opengl_workshop/src/00_getting_started/04_coordinate_systems/04_fragment.glsl");
